      ...
      {user ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-4 py-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            <button className="bg-black text-white px-8 py-4 rounded-lg font-medium hover:bg-gray-800 transition-all flex items-center gap-2">
            ...
            <button className="border-2 border-black text-black px-8 py-4 rounded-lg font-medium hover:bg-gray-50 transition-all flex items-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
